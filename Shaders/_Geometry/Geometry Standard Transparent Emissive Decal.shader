Shader "QcRendering/Geometry/Transparent Emissive Decal"
{
	Properties
	{
		...
		SubShader
		{
			...
			Pass
			{
				...
				float4 frag(v2f i) : COLOR
				{
					...
					float shadow = GetSunShadowsAttenuation(i.worldPos, i.screenPos.z);//getShadowAttenuation(i.worldPos);
					...
					float4 result = float4(col, tex.a);
					 ...
					 ApplyLayeredFog_Transparent(result, screenUV, i.worldPos.xyz);
