...
namespace UniStorm.Effects
{
    ...
    public class UniStormSunShafts : UniStormPostEffectsBase
    {
        ...
        public void Awake()
        {
            sunShaftsShader = Shader.Find("Hidden/UniStormSunShafts");
            simpleClearShader = Shader.Find("Hidden/UniStormSimpleClear");
            useDepthTexture = true;
            maxRadius = 0.5f;
            sunShaftBlurRadius = 4.86f;
            radialBlurIterations = 2;
            sunShaftIntensity = 1;
            sunTransform = GameObject.Find("Sun Transform").transform;
            Color SunColor;
            ColorUtility.TryParseHtmlString("#C8A763", out SunColor);
            sunColor = SunColor;
            Color ThresholdColor;
            ColorUtility.TryParseHtmlString("#8E897B", out ThresholdColor);
            sunThreshold = ThresholdColor;
        }
