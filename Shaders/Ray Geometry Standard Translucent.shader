Shader "RayTracing/Geometry/Standard Translucent"
{
	Properties
	{
...
#	endif
				...
				float3 bakeReflected = GetBakedAndTracedReflection(samplePos, reflectedRay, BLOOD_SPECULAR, i.traced);//SampleReflection(o.worldPos, viewDir, normal, shadow, hit);
